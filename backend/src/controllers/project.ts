...
export const createProject = async (req: Request, res: Response) => {
  try {
    ...
    return res
      .status(400)
      .json({ message: "Failed to create project.", error });
  }
};
...
export const getAllProjects = async (req: Request, res: Response) => {
  try {
    const projects = await prisma.project.findMany({
      include: {
        proposal: {
          select: { proposalTitle: true, user: { select: { username: true } } },
        },
        tasks: true,
      },
    });
    ...
    return res
      .status(400)
      .json({ message: "Failed to fetch projects.", error });
  }
};
...
export const getProjectById = async (req: Request, res: Response) => {
  ...
  try {
    ...
    return res
      .status(200)
      .json({ success: true, message: "project fetched", project });
  } catch (error) {
...
export const updateProjectById = async (req: Request, res: Response) => {
  try {
    ...
    return res
      .status(200)
      .json({ message: "Project updated successfully.", project: updated });
  } catch (error) {
    return res
      .status(400)
      .json({ message: "Failed to update project.", error });
  }
};
...
export const deleteProject = async (req: Request, res: Response) => {
  try {
    ...
    return res
      .status(400)
      .json({ message: "Failed to delete project.", error });
  }
};
